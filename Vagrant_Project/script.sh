...
sudo service apache2 restart
    ...
    CREATE USER 'olayinka'@'localhost' IDENTIFIED BY '01234567';
    GRANT ALL PRIVILEGES ON laraveldb . * TO 'olayinka'@'localhost';
...
DB_USERNAME="olayinka"
DB_PASSWORD="01234567"
